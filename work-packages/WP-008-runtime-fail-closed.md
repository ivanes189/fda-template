...
| C7 | Los eventos de ciclo de vida del hook llegan al flujo procesable | El evento del hook aparece en la salida `stream-json` con `--include-hook-events`, y el runner lo usa para decidir C1 a C6 |
